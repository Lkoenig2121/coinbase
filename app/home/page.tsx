          ...
          <aside className="lg:col-span-2">
            <div className="bg-white border border-gray-200 rounded-lg p-4">
              <nav className="space-y-2">
                <Link href="/home" className="flex items-center space-x-3 p-3 bg-coinbase-light-blue text-coinbase-blue rounded-lg">
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
                  </svg>
                  <span className="font-medium">Home</span>
                </Link>
                <Link href="/trade" className="flex items-center space-x-3 p-3 text-gray-700 hover:bg-gray-50 rounded-lg">
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <main className="lg:col-span-7 space-y-6">
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="bg-coinbase-blue text-white rounded-lg p-6 relative">
                  ...
                  <p className="text-sm text-white/90">Hear about the next chapter of Coinbase. Live on X 12/17.</p>
                </div>
                <div className="bg-gradient-to-br from-yellow-400 to-coinbase-blue text-white rounded-lg p-6 relative">
                  ...
                  <h4 className="font-semibold mb-2">Access up to $5M instantly</h4>
                  <p className="text-sm text-white/90">Get a USDC loan without selling your crypto.</p>
                </div>
                <div className="bg-coinbase-blue text-white rounded-lg p-6 relative">
                  <button className="absolute top-4 right-4 text-white/80 hover:text-white">
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <p className="text-sm text-white/90">Invite friends and earn</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white border border-gray-200 rounded-lg p-6">
              ...
              <div className="text-center py-8">
                ...
                <h4 className="font-semibold text-gray-900 mb-2">Build your watchlist</h4>
                <p className="text-gray-600 mb-4">Keep track of crypto prices by adding assets to your watchlist</p>
